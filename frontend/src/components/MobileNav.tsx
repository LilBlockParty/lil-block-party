        ...
        >
          ...
          >
            <div className="flex flex-row-reverse items-center justify-between">
              ...
              <h2 className="text-4xl font-medium text-zinc-400 dark:text-zinc-300">Navigation</h2>
            </div>
            <nav className="mt-6">
              <ul className="my-12  text-3xl text-zinc-300 mb-12 flex flex-col gap-y-12 justify-center items-start w-full">
                <MobileNavItem href="/about">WTF?</MobileNavItem>
                <MobileNavItem href="/articles">Dune</MobileNavItem>
                <MobileNavItem href="/projects">Twitter</MobileNavItem>
              </ul>
